...
//         if (maxSecondsToLoseSoul < secondsPassed && !_gameSession.IsSoulPlaced())
//         {
//             _gameSession.TookTooLongToLoseSoul();
//         } else if (_secondsToRecoverSoul < secondsPassed && _gameSession.IsSoulPlaced())
//         {
//             _gameSession.PlayerTookTooLong();
//         }
//     }
// }
